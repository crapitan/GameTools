...
namespace GameTools
{
    ...
    static class Fonts
    {
        ...
        private static SpriteFont peric18;
        public static SpriteFont Peric18
        {
            get { return peric18; }
        }

        private static SpriteFont peric24;
        public static SpriteFont Peric24
        {
            get { return peric24; }
        }

        private static SpriteFont peric36;
        public static SpriteFont Peric36
        {
            get { return peric36; }
        }

        private static SpriteFont segoeMono;
        public static SpriteFont SegoeMono
        {
            get { return segoeMono; }
        }
        ...
        public static readonly Color MenuSelectedColor = new Color(245, 235, 217);

        public static readonly Color FadedBlack = new Color(Color.Black, 0.75f);
        ...
        public static void LoadContent(ContentManager contentManager)
        {
            ...
            peric18 = contentManager.Load<SpriteFont>(@"Fonts/Peric-18");
            peric24 = contentManager.Load<SpriteFont>(@"Fonts/Peric-24");
            peric36 = contentManager.Load<SpriteFont>(@"Fonts/Peric-36");
            segoeMono = contentManager.Load<SpriteFont>(@"Fonts/SegoeMono-12");
            defaultFont = peric18;
